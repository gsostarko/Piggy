...
def pdf_kolinja(id):
    ...
    pdf.cell(col_width, line_height, f'{float(sum_meso,1)}', 1, 0, 'C')
    pdf.cell(col_width, line_height, f'{float(sum_sol,1)}', 1, 0, 'C')
    pdf.cell(col_width, line_height, f'{float(sum_papar,1)}', 1, 0, 'C')
    pdf.cell(col_width, line_height, f'{float(sum_ljuta_p,1)}', 1, 0, 'C')
    pdf.cell(col_width, line_height, f'{float(sum_slatka_p,1)}', 1, 0, 'C')
    pdf.cell(col_width, line_height, f'{float(sum_bijeli_luk,1)}', 1, 0, 'C')
    pdf.ln(line_height)
    pdf.cell(col_width*9, line_height, f'')
    pdf.cell(col_width*2, line_height, f'SVEUKUPNO (g):',1,0,'L')
    pdf.cell(col_width, line_height, f'{float(ukupno_meso,1)}',1,0,'C')
